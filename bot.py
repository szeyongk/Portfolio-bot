...
PORTFOLIO = [
dict(ticker='AVUV', name='Amer Century SCV', shares=6.5604, avg_cost=119.61, cost_currency='dict(ticker='GOOGL', name='Alphabet (GOOGL)', shares=5.5913, avg_cost=380.07, cost_currency='dict(ticker='NVDA', name='NVIDIA', shares=18.0057, avg_cost=211.549, cost_currency='USD', dict(ticker='QQQ', name='Invesco QQQ', shares=3.5397, avg_cost=660.853, cost_currency='USD', dict(ticker='SCHD', name='Schwab Dividend', shares=30.1421, avg_cost=31.24, cost_currency='dict(ticker='VOO', name='Vanguard S&P 500', shares=14.0411, avg_cost=654.067, cost_currency='dict(ticker='VXUS', name='Vanguard Intl', shares=2.8491, avg_cost=82.479, cost_currency='dict(ticker='Z74.SI', name='Singtel', shares=100, avg_cost=3.287, cost_currency='SGD', account='dict(ticker='CRO-USD', name='Cronos (CRO)', shares=7724.05, avg_cost=0.5988, cost_currency='dict(ticker='ETH-USD', name='Ethereum (ETH)', shares=0.18215232, avg_cost=4720.75, cost_currency='dict(ticker='ETHW-USD', name='EthereumPoW', shares=0.18215232, avg_cost=0.38, cost_currency=']
MANUAL_POSITIONS = [
